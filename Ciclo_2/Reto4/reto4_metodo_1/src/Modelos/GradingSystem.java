...
public class GradingSystem {
    ...
    public String stat3(){                                                       
        ...
        for(int x=0;x<matriz.length;x++){
            ...
            if (matriz[x][1].equals("0.0")){
                notasM=notasM+Float.parseFloat(matriz[x][3]);
                contM++;
            } else if(matriz[x][1].equals("1.0")){
    ...
    public String stat4(){                                                    
        ...
        float mayor=0;
        for(int x=0;x<matriz.length;x++){
            if(Float.parseFloat(matriz[x][2])==1.0){
        ...
        String [] temp=obj.castControl(Double.valueOf(mejorEstIdiomas),0);
        mejorEstIdiomas=temp[0];
